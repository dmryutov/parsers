# -*- coding: utf-8 -*-
"""
@brief:  Extract judicial acts from `bsr.sudrf.ru` (multithread version)
@file:   multithread.py
...
def main():
    ...
    for _, site in settings.FIRST_ACT.items():
        thread = Thread(target=extract_acts, args=(site, csv_writer))
        thread.start()
